...
<head>
    ...
    <style>
        :root {
            --cp-bg: #06060c;
            --cp-bg-soft: #0c0c17;
            --cp-panel: rgba(15, 15, 29, 0.86);
            --cp-panel-solid: #10101d;
            --cp-text: #f5f7ff;
            --cp-muted: #a8aec5;
            --cp-cyan: #00f6ff;
            --cp-pink: #ff2bd6;
            ...
            --cp-green: #69ff97;
            --cp-red: #ff476f;
            --cp-border: rgba(0, 246, 255, 0.28);
            --cp-shadow: 0 0 24px rgba(0, 246, 255, 0.14);
        ...
        body {
            ...
            color: var(--cp-text);
            background:
                radial-gradient(circle at 10% 10%, rgba(255, 43, 214, 0.12), transparent 28%),
                radial-gradient(circle at 86% 24%, rgba(0, 246, 255, 0.12), transparent 26%),
                linear-gradient(180deg, #06060c 0%, #090914 48%, #06060c 100%);
        ...
        .cp-grid {
            ...
            transform: perspective(650px) rotateX(62deg) scale(1.5) translateY(22%);
        ...
        .brand-mark {
            ...
            box-shadow: 4px 4px 0 var(--cp-pink);
            clip-path: polygon(0 0, 84% 0, 100% 28%, 100% 100%, 16% 100%, 0 72%);
        }

        .brand-mark::after {
            position: absolute;
            inset: 4px;
            border: 1px solid rgba(6, 6, 12, 0.65);
            content: "";
            clip-path: inherit;
        }
        ...
        .cp-btn {
            ...
            box-shadow: inset 0 0 0 rgba(0, 246, 255, 0.2), 4px 4px 0 rgba(255, 43, 214, 0.55);
            font-size: 0.82rem;
            font-weight: 700;
        ...
        .cp-btn::before {
            ...
            inset: 0;
            content: "";
            background: linear-gradient(100deg, transparent 25%, rgba(255, 255, 255, 0.22), transparent 70%);
        ...
        .cp-btn:hover {
            color: #030306;
            background: var(--cp-cyan);
            box-shadow: 0 0 24px rgba(0, 246, 255, 0.42), 4px 4px 0 var(--cp-pink);
        ...
        .cp-btn-secondary {
            ...
            box-shadow: 4px 4px 0 rgba(0, 246, 255, 0.48);
        }

        .cp-btn-secondary:hover {
            background: var(--cp-pink);
            box-shadow: 0 0 24px rgba(255, 43, 214, 0.4), 4px 4px 0 var(--cp-cyan);
        }
        ...
        .hero {
            ...
            min-height: 100vh;
            align-items: center;
            padding-top: calc(var(--cp-header-height) + 2rem);
            overflow: hidden;
        }
        ...
        .hero::before {
            top: 12%;
            right: -160px;
            box-shadow: 0 0 80px rgba(0, 246, 255, 0.08);
        }
        ...
        .hero::after {
            ...
            box-shadow: 0 0 80px rgba(255, 43, 214, 0.08);
        }
        ...
        .hero-kicker::before {
            ...
            content: "";
            background: var(--cp-pink);
            box-shadow: 0 0 12px var(--cp-pink);
        }
        ...
        .hero-title .outline {
            color: transparent;
            -webkit-text-stroke: 1.5px var(--cp-cyan);
            text-shadow: 0 0 26px rgba(0, 246, 255, 0.2);
        }
        ...
        .section-title span {
            color: transparent;
            -webkit-text-stroke: 1px var(--cp-cyan);
        }
        ...
        .tech-card::after {
            ...
            height: 4px;
            content: "";
            background: var(--tech-color, var(--cp-cyan));
            box-shadow: 0 0 18px var(--tech-color, var(--cp-cyan));
            transform: rotate(45deg);
            transform-origin: right;
        }

        .tech-card:hover {
            border-color: var(--tech-color, var(--cp-cyan));
            box-shadow: 0 0 26px color-mix(in srgb, var(--tech-color, var(--cp-cyan)) 24%, transparent);
        ...
        .tech-icon {
            ...
            height: 58px;
            place-items: center;
            color: var(--tech-color, var(--cp-cyan));
            border: 1px solid currentColor;
            background: rgba(255, 255, 255, 0.025);
            box-shadow: inset 0 0 18px color-mix(in srgb, var(--tech-color, var(--cp-cyan)) 14%, transparent);
            font-size: 1.8rem;
        ...
        .about-panel {
            ...
            background:
                linear-gradient(135deg, rgba(0, 246, 255, 0.045), transparent 40%),
                var(--cp-panel);
            box-shadow: var(--cp-shadow);
        ...
        .about-panel::before {
            ...
            content: "";
            background: var(--cp-yellow);
            box-shadow: 0 0 14px var(--cp-yellow);
        }
        ...
        .profile-frame {
            ...
            background:
                linear-gradient(180deg, transparent, rgba(6, 6, 12, 0.84)),
                url("https://picsum.photos/seed/cyberpunk-profile/900/1100") center/cover;
            box-shadow: 12px 12px 0 rgba(0, 246, 255, 0.1);
        ...
        .profile-frame::before {
            ...
            inset: 0;
            content: "";
            background: linear-gradient(100deg, rgba(255, 43, 214, 0.12), transparent 45%, rgba(0, 246, 255, 0.14));
        ...
        .filter-btn.active {
            ...
            background: var(--cp-cyan);
            box-shadow: 0 0 18px rgba(0, 246, 255, 0.3);
        }
        ...
        .project-card:hover {
            ...
            box-shadow: 0 18px 40px rgba(0, 0, 0, 0.36), 0 0 28px rgba(0, 246, 255, 0.12);
        ...
        .project-media::after {
            ...
            content: "";
            background:
                linear-gradient(180deg, transparent 45%, rgba(6, 6, 12, 0.94)),
                linear-gradient(100deg, rgba(255, 43, 214, 0.12), transparent 40%, rgba(0, 246, 255, 0.11));
        }
        ...
        .project-category {
            ...
            color: var(--cp-yellow);
            border: 1px solid rgba(248, 243, 43, 0.4);
        ...
        .project-github:hover {
            color: var(--cp-pink);
            border-color: var(--cp-pink);
            box-shadow: 0 0 18px rgba(255, 43, 214, 0.38);
            transform: translateY(-2px);
        }

        .project-github.is-private {
            color: var(--cp-yellow);
            border-color: rgba(248, 243, 43, 0.45);
        }
        ...
        .project-tech:hover {
            color: var(--tech-color, var(--cp-cyan));
            border-color: var(--tech-color, var(--cp-cyan));
            box-shadow: 0 0 12px color-mix(in srgb, var(--tech-color, var(--cp-cyan)) 22%, transparent);
        }
        ...
        .private-repo-message {
            ...
            background: rgba(248, 243, 43, 0.07);
            font-size: 0.7rem;
            line-height: 1.5;
        }

        .private-repo-message.show {
            display: block;
        ...
        .contact-panel {
            ...
            background:
                linear-gradient(135deg, rgba(255, 43, 214, 0.05), transparent 45%),
                var(--cp-panel);
            box-shadow: 0 0 32px rgba(255, 43, 214, 0.08);
            clip-path: polygon(0 0, calc(100% - 34px) 0, 100% 34px, 100% 100%, 34px 100%, 0 calc(100% - 34px));
        }
        ...
        .form-select:focus {
            color: var(--cp-text);
            border-color: var(--cp-cyan);
            background-color: rgba(0, 246, 255, 0.04);
            box-shadow: 0 0 0 0.2rem rgba(0, 246, 255, 0.08) !important;
        }
        ...
        .cp-footer {
            padding: 2rem 0;
            border-top: 1px solid rgba(0, 246, 255, 0.13);
            color: var(--cp-muted);
            background: rgba(6, 6, 12, 0.78);
            font-size: 0.75rem;
        }
        ...
        .modal-content {
            ...
            color: var(--cp-text);
            background: #0a0a14;
            box-shadow: 0 0 60px rgba(0, 246, 255, 0.14);
        ...
        .cp-toast {
            border: 1px solid rgba(105, 255, 151, 0.38);
            border-radius: 0;
            color: var(--cp-text);
            background: #0d1814;
            box-shadow: 0 0 30px rgba(105, 255, 151, 0.12);
        }
        ...
        @media (max-width: 991.98px) {
            ...
            .hero {
                min-height: auto;
                padding-top: calc(var(--cp-header-height) + 5rem);
                padding-bottom: 6rem;
            }
...
<body>
    ...
    <script>
        ...
        const projects = [{
                ...
                excerpt: "Plataforma logística para administrar operaciones marítimas y ferroviarias.",
                description: "Sistema empresarial construido con arquitectura MVC para gestionar operaciones, clientes, contenedores, documentos, estatus y trazabilidad logística.",
                ...
                liveUrl: "",
                challenge: "Modelar flujos logísticos complejos, evitar duplicidades, validar saldos de mercancía y mantener integridad entre módulos.",
                result: "Centralización de la operación, reducción de captura duplicada y mayor visibilidad del estado de cada embarque.",
            ...
            },
            {
                ...
                category: "web",
                categoryName: "Sistema web",
                excerpt: "Plataforma para prevalidación, generación y envío de certificados técnicos.",
                description: "Sistema de certificación con gestión de folios concurrentes, validación documental, evidencias fotográficas, generación PDF/ZIP e integración con servicios externos.",
                ...
                liveUrl: "",
                challenge: "Garantizar consistencia de folios durante procesos concurrentes y asegurar que cada expediente cumpla con todas las evidencias obligatorias.",
                result: "Flujo digital trazable desde la captura hasta la emisión del certificado y el envío a plataformas externas.",
            ...
            },
            {
                ...
                excerpt: "Clúster doméstico con Docker Swarm, almacenamiento, DNS y servicios multimedia.",
                description: "Arquitectura distribuida de tres nodos para ejecutar servicios internos, almacenamiento compartido, proxy inverso, DNS local, monitoreo y aplicaciones multimedia.",
                ...
                liveUrl: "",
                challenge: "Distribuir cargas, persistir datos y mantener comunicación entre nodos con recursos de hardware heterogéneos.",
                result: "Plataforma modular, escalable y documentada para desplegar servicios y proyectos personales.",
                client: "",
                hasVideo: true
            },
            {
                ...
                excerpt: "Aplicación experimental en C# para transformar datos e imágenes en señales.",
                description: "Proyecto de aprendizaje orientado a procesamiento de señales, codificación, cifrado y construcción progresiva de una interfaz de escritorio.",
                ...
                liveUrl: "",
                challenge: "Comprender el tratamiento binario de imágenes y la conversión de información a una representación de audio.",
                result: "Base técnica para evolucionar de una aplicación de consola hacia una interfaz gráfica y un demostrador web.",
            ...
            },
            {
                ...
                excerpt: "Prototipo de aplicación para captura de evidencias y seguimiento en campo.",
                description: "Concepto de aplicación móvil que permite registrar visitas, geolocalización aproximada, fotografías, observaciones y sincronización posterior.",
                ...
                liveUrl: "",
                challenge: "Mantener una experiencia útil con conectividad limitada y sincronizar información al recuperar acceso a red.",
                result: "Prototipo funcional para validar el flujo antes de construir la versión productiva.",
            ...
            },
            {
                ...
                excerpt: "Panel conceptual para revisar eventos, accesos y alertas de infraestructura.",
                description: "Dashboard enfocado en visibilidad de eventos, autenticaciones, disponibilidad y señales básicas de riesgo en servicios internos.",
                ...
                liveUrl: "",
                challenge: "Consolidar señales de diferentes fuentes y presentarlas sin generar ruido operativo.",
                result: "Vista centralizada para detectar anomalías y priorizar acciones de revisión.",
                client: "Proyecto personal",
                hasVideo: false
            }
        ];
        ...
        `)
            ...
            githubLink.classList.toggle("d-none", project.github.private || !project.github.url);
